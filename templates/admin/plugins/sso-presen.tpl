<div class="row">
	<div class="col-sm-2 col-xs-12 settings-header">Presen SSO</div>
	<div class="col-sm-10 col-xs-12">
		<div class="alert alert-info">
			<p>
				Register a new <strong>Presen Application</strong>
			</p>
		</div>
		<form class="sso-github-settings">
			...
			<div class="form-group alert alert-warning">
				...
				<p class="help-block">
					Ensure that this value is set in your Presen application&apos;s settings
				</p>
			</div>
			<div class="checkbox">
